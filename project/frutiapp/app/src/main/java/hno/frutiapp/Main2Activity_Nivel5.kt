...
class Main2Activity_Nivel5 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(this,"Nivel 5 Multiplicacion basicas", Toast.LENGTH_LONG).show()
    ...
    fun NumeroAleatorio(){
        if(score <=  49){
            ...
            val intent =  Intent(this,Main2Activity_Nivel6::class.java)
