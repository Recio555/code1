...
class Main2Activity_Nivel3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Toast.makeText(this,"Nivel 3 Restas basicas", Toast.LENGTH_LONG).show()
    ...
    fun NumeroAleatorio(){
        if(score <= 29){
            ...
            val intent =  Intent(this,Main2Activity_Nivel4::class.java)
